      ...
      <header className="border-b">
        <div className="container max-w-6xl mx-auto flex justify-between items-center p-5">
          ...
          <div className="w-1/6 flex justify-end">
            <a href="/login" className="mx-3 text-gray-500 hover:text-gray-800" rel="noopener noreferrer">
              Log In
            </a>
            <a href="/signup" className="mx-3 text-gray-500 hover:text-gray-800" target="_blank" rel="noopener noreferrer">
              Sign Up
            </a>
          </div>
        </div>
